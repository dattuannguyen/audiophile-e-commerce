                ...
                <div className="flex justify-between pb-[32px] border-b-mateGray border-b-[0.5px] items-center">
                    ...
                    <div className="md:shrink-0 hidden xl:block">
                        <ul className="flex flex-grow justify-center items-center gap-8 text-trueWhite font-manropeBold uppercase text-[13px]">
                            <li className="hover:cursor-pointer hover:text-darkOrange">Home</li>
                            <li className="hover:cursor-pointer hover:text-darkOrange">Headphones</li>
                            <li className="hover:cursor-pointer hover:text-darkOrange">Speakers</li>
                            <li className="hover:cursor-pointer hover:text-darkOrange">Earphones</li>
                        </ul>
                    </div>
